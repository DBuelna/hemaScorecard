...
function displayEventButton($eventID, $eventInfo)
{
    ...
    <button value='<?= $eventID ?>' style='width:100%' class='button hollow <?= $isActive ?>' name='changeEventTo' >
        <?= $name . ", " . $year ?>
...
function confirmDeleteReveal($formID, $formName)
{
    ...
    <div class='reveal medium text-center' id='confirmDelete' data-reveal>
        ...
        <p>You are attempting to delete fighters who have already fought and/or groups which have already started.</p>
